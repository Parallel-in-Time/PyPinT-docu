...
\begin{frame}
  ...
  \begin{itemize}
    \item \texttt{pypint.communicators}
    \item \texttt{pypint.integrators}
    \item \texttt{pypint.multi\_level\_providers}
    \item \texttt{pypint.plugins}
    \item \texttt{pypint.problems}
    \item \texttt{pypint.solvers}\\
      {\hspace{5em}\scriptsize \texttt{\textasciitilde.cores}, \texttt{\textasciitilde.states}}
    \item \texttt{pypint.solutions}
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \begin{picture}(1,1)
    \put(-77,185){\includegraphics[height=2cm]{src/pint_logo.png}}
  \end{picture}
\end{frame}
