...
\end{columns}
              ...
              \end{align*}
    What is needed? \textcolor{fzjyellow}{Two Integrators},  \textcolor{fzjyellow}{Evaluation of $F$}
...
What is needed? \textcolor{fzjyellow}{Quadrature},  \textcolor{fzjyellow}{Evaluation of $F$} $\longrightarrow$ \textcolor{fzjyellow}{new Integrator}
...
\begin{columns}[T]
  \begin{column}{3cm}
        What is needed? 
	\begin{itemize}
	  \item \textcolor{fzjyellow}{Quadrature}
...
comm.write_buffer(value=problem.initial_value,
                  time_point=problem.time_start)

solver.init(problem=problem, num_nodes=3)
