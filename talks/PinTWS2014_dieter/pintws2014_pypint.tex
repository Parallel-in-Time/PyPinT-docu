...
\begin{frame}
  ...
  \begin{center}
    ...
    \begin{picture}(1,1)
      \put(-155,0){\includegraphics[height=0.5cm]{src/bug_blank_wikimedia.pdf}}
      \put(-115,0){\includegraphics[height=0.5cm]{src/bug_blank_wikimedia.pdf}}
      \put(-75,0){\includegraphics[height=0.5cm]{src/bug_blank_wikimedia.pdf}}
      \put(-45,0){\includegraphics[height=0.5cm]{src/bug_blank_wikimedia.pdf}}
      \put(-15,0){\includegraphics[height=1cm]{src/bug_blank_wikimedia.pdf}}
      \put(30,0){\includegraphics[height=0.5cm]{src/bug_blank_wikimedia.pdf}}
      \put(65,0){\includegraphics[height=0.5cm]{src/bug_blank_wikimedia.pdf}}
      \put(105,0){\includegraphics[height=0.5cm]{src/bug_blank_wikimedia.pdf}}
      \put(155,0){\includegraphics[height=0.5cm]{src/bug_blank_wikimedia.pdf}}
    \end{picture}
  \end{center}
\end{frame}
