...
\begin{frame}
  \frametitle{Parareal}
  \framesubtitle{\scriptsize\normalfont  Y. Maday, “The parareal in time algorithm,” pp. 1–24, 2008.}
  \begin{columns}[T]
    \begin{column}{4cm}
      \begin{itemize}
...
\end{columns}
              ...
              \end{align*}
    What is needed?\textcolor{fzjyellow}{Two Integrator},  \textcolor{fzjyellow}{Evaluation of $F$}
...
What is needed? \textcolor{fzjyellow}{Quadrature},  \textcolor{fzjyellow}{Evaluation of $F$}
...
\end{align*}
\center and multiple level, correction $\textcolor{fzjblue30}{\tau_{n}^{k}}$ stems from informations on different level
\\[1.5em]
\begin{columns}[T]
  \begin{column}{3cm}
        What is needed? 
